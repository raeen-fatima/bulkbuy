  ...
  return (
    <header className="bg-blue-300/20 backdrop-blur-md shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <Link
          to="/"
          className="flex items-center gap-2 text-2xl sm:text-3xl font-extrabold font-sans tracking-tight text-indigo-600 hover:opacity-90 transition"
        >
      ...
      {isOpen && (
        <div className="md:hidden px-6 pb-4 space-y-3">
          <Link
            ...
            className="block text-blue-950 border-2 border-blue-950 py-2 px-4 rounded-full text-center font-medium hover:bg-blue-950 hover:text-white transition"
          >
            Login/Sign Up
          </Link>
          <Link
